    ...
    <main className="min-h-screen py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12">
          <ProjectGallery images={project.images} isMobile={project.isMobile} />

          {project.videoLink && (
            <div>
              <h2 className="text-2xl font-semibold mb-4">Project Demo</h2>
              <VideoEmbed videoLink={project.videoLink} />
            </div>
          )}
          ...
          {/* <div className="flex gap-4">
            {project.githubLink && (
              <a
                ...
                className="inline-flex items-center px-4 py-2 rounded-lg bg-gray-800 text-white hover:bg-gray-900 transition-colors"
              >
                <svg
                  className="w-5 h-5 mr-2"
                  fill="currentColor"
